...
export const GAMES = [
  ...
  },
  {
    ...
    name: 'Falling Blocks',
    category: 'arcade',
    tagline: 'Line up three jewels of a colour and set off chain reactions.',
    players: [1, 8],
    onlineDefault: 2,
    bots: false,
    leaveMode: 'forfeit',
    ...
    options: [],
    rules: [
      'A column of three jewels falls into the well. Move it left and right, and cycle the order of its jewels.',
      'Line up three or more jewels of the same colour across, down or diagonally and they disappear.',
      'Jewels above then fall, which can line up more: every step of a chain reaction scores more.',
      'Keys: ← → move, ↑ or X cycle, ↓ soft drop, Space hard drop, P pause. Touch: tap to cycle, drag to move, flick down to drop.',
      'Every colour has its own shape, so the jewels are easy to tell apart.',
      'The pace picks up every 30 jewels. The game ends when the well overflows.',
    ],
  },
  {
    id: 'pinball',
