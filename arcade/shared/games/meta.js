...
export const GAMES = [
  ...
  },
  {
    ...
    name: 'Liar’s Dice',
    category: 'puzzle',
    tagline: 'Hide your dice, bid boldly, call the bluff.',
    players: [2, 6],
    onlineDefault: 3,
    bots: true,
    leaveMode: 'bot',
    ...
    options: [
      {
        ...
        default: '5',
        choices: [
          { value: '5', label: '5 dice' },
          { value: '3', label: '3 dice (quick)' },
        ],
      },
      { key: 'wild', label: 'Ones are wild', type: 'bool', default: true },
      { key: 'spot', label: 'Allow “spot on” calls', type: 'bool', default: true },
    ],
    rules: [
      'Everyone rolls their dice in secret. Only you can see yours.',
      'Take turns bidding on how many dice on the whole table show a face, for example “four 5s”. Each bid must raise the last one: more dice, or the same number of a higher face.',
      'Instead of bidding you can call “Liar!”. All dice are revealed: if there are fewer than bid, the bidder loses a die, otherwise you do.',
      'With ones wild, every 1 counts as the face being bid (and nobody bids on 1s).',
      'Spot on: claim the bid is exactly right. If it is, everyone else loses a die. If not, you lose one.',
      'Lose all your dice and you are out. The last player with dice wins.',
    ],
  },
  {
    id: 'mastermind',
